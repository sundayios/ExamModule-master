...
- (void)setModel:(QuestionListModel *)model {
    ...
    NSMutableAttributedString *labelatt = [NSMutableAttributedString attachmentStringWithContent:self.typeLabel contentMode:(UIViewContentModeCenter) attachmentSize:(self.typeLabel.frame.size) alignToFont:self.textView.font alignment:YYTextVerticalAlignmentTop];
